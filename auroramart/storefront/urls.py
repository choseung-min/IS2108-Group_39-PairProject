...
urlpatterns = [
    ...
    path('cart/recommendations/', views.recommend_addons_view, name='cart_recommendations'),
    ...
    path('account/orders/<int:order_id>/received/', views.order_mark_received, name='order_mark_received'),
